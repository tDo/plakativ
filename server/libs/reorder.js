...
var helpers = require(__dirname + '/../models/helpers');

/**
 * The reorder-library allows us to handle placement of childs items
 ...
 */
module.exports = function(parent, item, position, transaction, options) {
    ...
    function validateParent(obj) {
        if (!helpers.isModelOfType(obj, options.parentModel)) { return false; }
        return !obj.isNewRecord;
    }

    function validateChild(obj) {
        if (!helpers.isModelOfType(obj, options.childModel)) { return false; }
        return !obj.isNewRecord;
    }
